    ...
    <div className="container">
      <div className="card shadow-sm">
        <div className="card-body">
          ...
          <p className="mb-3">
            Desa Sawangan dengan Luas Wilayah keseluruhan 892 Hektar, terdiri dari dataran 
            pemukiman penduduk, perbukitan dan lembah serta areal pertanian, dengan batas 
            wilayah : Sebelah Utara berbatasan dengan Desa Tikela/ Maumbi Kalawat, Sebelah 
            Timur berbatasan dengan Desa Maumbi dan Desa Kuwil Sebelah Selatan berbatasan 
            dengan Desa Kamangta dan Desa Tombuluan Sebelah Barat berbatasan dengan Desa 
            Kamangta dan Desa Tikela.
          </p>
          <hr />
          <p className="mb-3">
            Desa Sawangan terbagi dalam 6 Wilayah Jaga, dimana masing-masing jaga dikoordinir 
            oleh Kepala Jaga yang disebut Pala dan Meweteng yang berfungsi mengawasi dan 
            mengkoordinir aktifitas pembangunan dan pelayan masyarakat di masing-masing wilayahnya.
          </p>
